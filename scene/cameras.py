...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
        ...
        self.meta_only =meta_only #meta_only is True means image is a PIL img, otherwise a tensor 
        self.resolution = resolution #the PIL img is in the target resolution, and the tensor need to be downsize in the dataset
        try:
